...
import (
	...
	"github.com/go-basic-frames/internal/apiserver/handler"
	"github.com/go-basic-frames/internal/apiserver/pkg/validation"
	"github.com/go-basic-frames/internal/apiserver/store"
...
func (cfg *Config) NewServer() (*Server, error) {
	...
	storeObj := store.NewStore(db)
	cfg.InstallRESTAPI(engine, storeObj)
...
func (s *Server) Run() error {
	// 运行 HTTP 服务器
	// 打印日志，提示 HTTP 服务已经起来，方便排障
	slog.Info("Start to listening the incoming requests on http address",
		"addr", s.cfg.Addr)
	go func() {
